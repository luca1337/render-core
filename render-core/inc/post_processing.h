...
public:
    ...
    post_processing(const window& window);

    virtual inline auto render_to_scene(const float delta_time, const std::function<void()>& render_scene_hook, const std::function<void()>& render_gui_hook = nullptr) -> void
    {
